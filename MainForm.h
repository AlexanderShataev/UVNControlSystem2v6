		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->управлениеПроцессомToolStripMenuItem,
					this->настройкаНагреваToolStripMenuItem, this->настройкаДоступаToolStripMenuItem, this->настройкиОтображенияToolStripMenuItem
			});
			...
			this->настройкаДоступаToolStripMenuItem->Size = System::Drawing::Size(58, 20);
			this->настройкаДоступаToolStripMenuItem->Text = L"Доступ";
			// 
			...
			this->f_button_set_butterfly->Text = L" Установить";
